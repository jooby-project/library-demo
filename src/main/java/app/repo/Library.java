 ...
 * <p>
 * This interface handles all the work of finding, saving, and removing
 * books and authors from the database. You don't need to write the code
 * for this; the system builds it automatically based on these method names.
 * </p>
 */
@Repository
